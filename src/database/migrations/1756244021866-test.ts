...
export class Test1756244021866 implements MigrationInterface {
    name = 'Test1756244021866'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "documentos" ("id" SERIAL NOT NULL, "viaje_id" integer NOT NULL, "tipo_id" integer NOT NULL, "link" character varying(255) NOT NULL, "observaciones" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_30b7ee230a352e7582842d1dc02" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "municipios" ("id" SERIAL NOT NULL, "nombre" character varying(100) NOT NULL, "codigo" character varying(10), "departamento_id" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_10d04b4b4e39ba40240b61e919d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "viajes" ("id" SERIAL NOT NULL, "fecha" date NOT NULL, "manifiesto" character varying(100) NOT NULL, "valor" integer NOT NULL, "comision" integer NOT NULL, "descargue" integer NOT NULL, "cheque" integer NOT NULL, "total_neto" integer NOT NULL, "porcentaje_65" integer NOT NULL, "porcentaje_35" integer NOT NULL, "valor_anticipo" integer NOT NULL, "saldo_a_pagar" integer NOT NULL, "saldos_anticipos" integer NOT NULL, "pago_completado" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "empresa_id" integer NOT NULL, "origen_id" integer NOT NULL, "destino_id" integer NOT NULL, "vehiculo_id" integer NOT NULL, CONSTRAINT "UQ_a35b04e26684154eeed46e79f6f" UNIQUE ("manifiesto"), CONSTRAINT "PK_494f8b59dff1674f6b4efbcea2a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "vehiculos" ("id" SERIAL NOT NULL, "placa" character varying(10) NOT NULL, "marca" character varying(50) NOT NULL, "modelo" character varying(50) NOT NULL, "activo" boolean NOT NULL DEFAULT true, CONSTRAINT "UQ_a9455f3a37d1d922a10f51664e9" UNIQUE ("placa"), CONSTRAINT "PK_bc0b75baae377e599cd46b502e1" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "movimientos" ("id" SERIAL NOT NULL, "fecha" date NOT NULL, "tipo" character varying(100) NOT NULL, "descripcion" character varying(255) NOT NULL, "valor" numeric(15,2) NOT NULL, "link" character varying, "pago" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_519702aa97def3e7c1b6cc5e2f9" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "viajes" ADD CONSTRAINT "FK_6325acfad8ca087fd15cebb0bcf" FOREIGN KEY ("vehiculo_id") REFERENCES "vehiculos"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "viajes" DROP CONSTRAINT "FK_6325acfad8ca087fd15cebb0bcf"`);
